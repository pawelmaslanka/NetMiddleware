...
::grpc::Status LagManagement::Stub::CreateLag(::grpc::ClientContext* context, const ::Net::Lag& request, ::Net::Result* response) {
  return ::grpc::internal::BlockingUnaryCall< ::Net::Lag, ::Net::Result, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_CreateLag_, context, request, response);
}

void LagManagement::Stub::async::CreateLag(::grpc::ClientContext* context, const ::Net::Lag* request, ::Net::Result* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::Net::Lag, ::Net::Result, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_CreateLag_, context, request, response, std::move(f));
}

void LagManagement::Stub::async::CreateLag(::grpc::ClientContext* context, const ::Net::Lag* request, ::Net::Result* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::Net::Result>* LagManagement::Stub::PrepareAsyncCreateLagRaw(::grpc::ClientContext* context, const ::Net::Lag& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::Net::Result, ::Net::Lag, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_CreateLag_, context, request);
}

::grpc::ClientAsyncResponseReader< ::Net::Result>* LagManagement::Stub::AsyncCreateLagRaw(::grpc::ClientContext* context, const ::Net::Lag& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
::grpc::Status LagManagement::Stub::DeleteLag(::grpc::ClientContext* context, const ::Net::Lag& request, ::Net::Result* response) {
  return ::grpc::internal::BlockingUnaryCall< ::Net::Lag, ::Net::Result, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_DeleteLag_, context, request, response);
}

void LagManagement::Stub::async::DeleteLag(::grpc::ClientContext* context, const ::Net::Lag* request, ::Net::Result* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::Net::Lag, ::Net::Result, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_DeleteLag_, context, request, response, std::move(f));
}

void LagManagement::Stub::async::DeleteLag(::grpc::ClientContext* context, const ::Net::Lag* request, ::Net::Result* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::Net::Result>* LagManagement::Stub::PrepareAsyncDeleteLagRaw(::grpc::ClientContext* context, const ::Net::Lag& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::Net::Result, ::Net::Lag, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_DeleteLag_, context, request);
}

::grpc::ClientAsyncResponseReader< ::Net::Result>* LagManagement::Stub::AsyncDeleteLagRaw(::grpc::ClientContext* context, const ::Net::Lag& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
LagManagement::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< LagManagement::Service, ::Net::Lag, ::Net::Result, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](LagManagement::Service* service,
...
::grpc::Status LagManagement::Service::CreateLag(::grpc::ServerContext* context, const ::Net::Lag* request, ::Net::Result* response) {
  (void) context;
  (void) request;
  (void) response;
...
::grpc::Status LagManagement::Service::DeleteLag(::grpc::ServerContext* context, const ::Net::Lag* request, ::Net::Result* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
