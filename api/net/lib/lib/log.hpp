...
namespace Log {
    ...
    public:
        ...
        virtual SharedPtr<Logger> getLogger([[maybe_unused ]] const String &) override {
            static SharedPtr<Logger> logger = MakeSharedPtr<Logger>("");
            return logger;
        };
    };
    ...
    public:
        ...
        virtual void registerModule(const String &module_name) override {
            _logger_by_module_name[module_name] = MakeSharedPtr<Logger>(module_name, _sinks_list);
        }
        ...
        virtual SharedPtr<Logger> getLogger(const String &module_name) override {
            ...
            if (logger_it == _logger_by_module_name.end()) {
                ...
                _logger_by_module_name[module_name] = MakeSharedPtr<Logger>(module_name);
