...
RstpMembersRequestHandle::RstpMembersRequestHandle(StringView module_name, SharedPtr<ModuleRegistry> module_registry, SharedPtr<Node> parent)
  : Node(MEMBERS_NODE_NAME, parent), RequestHandle(module_name, module_registry, MEMBERS_NODE_NAME, parent) {}

bool RstpMembersRequestHandle::handle(IRequestHandle::Request& req, IRequestHandle::Response& res) {
