...
class LagManager final : public Net::ILagQueryable, public Observer::IPublisher,
                         public std::enable_shared_from_this<LagManager> {
public:
    LagManager(StringView module_name, SharedPtr<ModuleRegistry> module_registry,
